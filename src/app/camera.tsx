  ...
  const handleOverride = async () => {
    ...
    try {
      const overriddenDecision =
        result.decision === "Recycle" ? "Resell" : "Recycle";
      ...
      {result ? (
            ...
            {result.decision === "AskClarification" ? (
              ...
              <View>
                ...
                <View style={styles.categoryIconWrapper}>
                  <Ionicons
                    name={
                      (CATEGORY_ICONS[result.category] || "cube-outline") as any
                    }
                    size={28}
                    color="#5bc4f5"
                  />
                ...
                <View
                  style={[
                    ...
                    {
                      backgroundColor:
                        result.decision === "Resell" ? "#4CAF50" : "#FF9800",
                    },
                  ]}
                >
                ...
                {result.estimatedValue > 0 && (
                  <View style={styles.valueBox}>
                    <Text style={styles.valueText}>
                      Est. Resale Value: ${result.estimatedValue}
                    </Text>
                  </View>
                )}
        ...
        <CameraView style={styles.camera} ref={cameraRef} facing={facing}>
          <SafeAreaView style={styles.uiOverlay}>
            {/* Top row: back button left, flip button right */}
            ...
            <View style={styles.counterBadge}>
              <Text style={styles.scanInstruction}>
                {photoBatch.length === 0
                  ? "Point & Scan"
                  : `${photoBatch.length} Photos Captured`}
              </Text>
            </View>
